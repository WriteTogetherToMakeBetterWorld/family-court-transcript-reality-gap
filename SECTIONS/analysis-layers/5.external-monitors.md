...
**1. Do independent observers validate the reality gap?** External (TP) and internal (TIG) observers using different methods identify the same barriers—does this convergence confirm architectural dysfunction?

**2. What can observers actually monitor?** Both external and internal observers focus overwhelmingly on Publication (visible reforms, published judgments) rather than Obtaining (costs, refusals, penetration)—what does this asymmetry reveal?

**3. Can reform processes measure their own effectiveness?** When transparency reforms themselves lack transparency metrics, what does this recursive opacity demonstrate?
