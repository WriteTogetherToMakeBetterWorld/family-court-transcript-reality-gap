...
**The knowledge gap:** Users often find forms and procedures incomprehensible without external help. TP's educational output confirms that official guidance creates knowledge deficits requiring external explanation.
...
**The reporting gap:** Although rules are updated, the system generates no central record of changes, leaving external observers to reconstruct timelines and assess impact.
