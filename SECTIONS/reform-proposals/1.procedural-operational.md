...
| Layer | Adult Voice Present | Children's Voice Absent | Consequence | Suggested Implementation |
|-------|---------------------|-------------------------|-------------|--------------------------|
| **L1: Institutional Design** | MOJ/HMCTS design forms, guidance, procedures | Forms presume adult applicants; no provisions for children requesting their own records | Children cannot initiate access to transcripts of proceedings about their lives | Chapter 8 (Procedural: Revise forms/guidance for child access) + Chapter 10 (Roadmap: Phase 1 rollout) |
| **L2: Judicial Gatekeeping** | Judges apply paramountcy in individual cases, exercise discretion on publication | 2016: NYAS young people consulted on anonymisation practices but not on whether publication serves their interests; June 2024 Guidance conditions consultation on legal representation (para. 3.13); Policy framework developed outside paramountcy principle; Children's views represented in individual cases through Cafcass/solicitors but children not consulted on policy frameworks | - Judges decide "in children's interests" within framework children didn't inform<br>- Even when individual children's views are represented in cases or consulted about policy, framing limits what questions they can address<br>- Children without legal representation have no mechanism to express views on publication decisions in their specific cases | Chapter 9 (Structural: Mandatory child consultation mechanisms) + Chapter 10 (Roadmap: Phase 2 testing) |
| **L3: Professional Mediation** | Solicitors/barristers navigate procedures, develop informal expertise | In individual cases, lawyers represent children's interests as interpreted by professionals; in policy development, children's perspectives are absent entirely; direct participation by children in either context remains rare | Children's preferences in individual cases filtered through professional judgment, rarely articulated directly; voice conflated with representation; no mechanisms for children's collective input into policy | Chapter 9 (Structural: Shift from representation to direct voice protocols) + Chapter 8 (Procedural: Training for child-led input) |
| **L4: User Experience** | Parents/litigants report barriers (costs, delays, complexity) | Children are "users" whose life histories are documented but who cannot access records | Ultimate stakeholders excluded from system designed for their benefit | Chapter 8 (Procedural: Child access portals/forms) + Chapter 10 (Roadmap: Phase 1 user testing) |
...
10.3.6 The Missing Voice in Roadmap Design
This roadmap (WHY/WHAT/HOW/WHEN/WHO) was drawn by adults analyzing systemic failures across six layers. But Layer 6 revealed a fundamental limitation: we developed solutions without asking those most affected.
Each roadmap element requires children's input:
WHY (Purpose):

Do these objectives actually serve you?
What purposes matter that we didn't list?
...
Would these processes work for you?
...
Where should children have decision-making power?

The roadmap exists, but its legitimacy depends on whether children validate, modify, or reject it.
